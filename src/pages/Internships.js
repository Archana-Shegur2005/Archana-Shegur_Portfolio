...
import {internships} from '../components/constabts'
...
const Internships = () => {
    return (
        <>
            <div id='internships' className=" con flex flex-col justify-center relative z-[1] items-center  mb-32 bg-black">
                <div className= " wra max-w-[1100px] relative flex flex-col justify-between w-full gap-3">
                    <div className="project_title mb-20" data-aos="zoom-in" data-aos-duration="1000">
                        <h1 className='lg:text-3xl text-center text-white font-semibold md:text-xl '><span className='px-8 pb-3 border-b-4 border-teal-400 '>Internships</span> </h1>
                    </div>
